import { auth, database, facebookProvider } from "../../config/firebase";
...
export function getUser(user, callback) {
    database.ref('user').child(user.uid).once('value')
        .then((snapshot) => {
...
export function resettPassword(data, callback) {
    const { email } = data;
    auth.sendPasswordResetEmail(data, callback)
